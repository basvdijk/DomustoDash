function updateSwitchBlinds(gridCell, cellConfig, data) {

  gridCell.addClass('switch');

  gridCell.find('.grid__cell__value').html(data.Data == 'Open' ? config.switch.labelOpen : config.switch.labelClose);
